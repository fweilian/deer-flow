...
class ExtensionSpec(BaseModel):
    ...
    table_prefix: str | None = Field(
        ...
        description=(
            ...
            "MetaData and migration chain. DeerFlow does not manage extension "
            "tables or migrations; the prefix remains operator metadata for the "
            "extension's own migration tooling. Omit it when no prefix is used."
        ),
    )
