...
export function useThreadStream({
  ...
  }, [onFinish, onSend, onStart, onThreadUpdate, onToolEnd]);
  ...
  const mergedThread = {
    ...thread,
    values: shouldOverrideValues ? latestThreadValues : thread.values,
    messages: shouldOverrideMessages ? mergedMessages : thread.messages,
  } as typeof thread;
