...
The provisioner has no built-in messaging-provider runtime. Custom Channel extensions remain outside this service; the provisioner only supplies the generic sandbox, skill, and user-data mounts.
